...
//        Inductor L2 = new Inductor(33*Math.pow(10, -3), source.get_f());
//        Capacitor C3 = new Capacitor(180*Math.pow(10, -6), source.get_f());
...
//        Resistor R1 = new Resistor(100);
//        Inductor L2 = new Inductor(560*Math.pow(10, -3), source.get_f());
//        Capacitor C3 = new Capacitor(20*Math.pow(10, -6), source.get_f());
//        SerialCircuit circuit = new SerialCircuit();
//        circuit.setSource(source);
//        circuit.addComponent(R1);
...
//        circuit.addComponent(C3);
        ...
        Inductor L2 = new Inductor(10*Math.pow(10, -3), source.get_f());
        Capacitor C3 = new Capacitor(20*Math.pow(10, -6), source.get_f());
        ParallelCircuit circuit = new ParallelCircuit();
        circuit.setSource(source);
        circuit.addComponent(R1);
